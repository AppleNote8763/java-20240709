...
//		int1 = 2_147_483_648L;
		...
		// 정수형 int를 연산 결과를 저장하는 데이터 타임으로 사용할 때는
		...
		// float : 4byte(32bit)의 크기를 가지는 실수형 데이터타입
		// 소수점 6~7 자리에서 오차가 발생
		// 실수형 리터럴 상수는 double 타입
		float float1 = 3.14159265358979323846F;
		System.out.println(float1);
		
		// double : 8byte(64bit)의 크기를 가지는 실수형 데이터타입
		...
		// new 데이터타입[베열의길이];
		// 배열의 길이는 바꿀수 없음
		// 배열의 길이를 바꾸고 싶으면 새로운 배열을 할당해야함
		int[] numbers;	//numbers 라는 배열변수생성
//		numbers = 3;
		numbers = new int[5];
...
//		System.out.println(numbers3[99]);
		...
		// 배열변수는 배열의 주소값을 가르킴
		// example1 = 배열변수 / new int[] {1, 2, 3} = 배열
		...
		// 배열, 클래스, 인터페이스, 열거형 참조형 데이터 타입에 속함
		String string2 = null;
