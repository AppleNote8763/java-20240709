...
public class Variable {
	...
	public static void main(String[] args) {
		...
		// 변수를 생성(선언)할 때는 반드시 해당 변수가 
		// 어떤 형태의 데이터를 가질 수 있는지 지정해야함
		
		
		// 선언(생성) 방법
		// 데이터타입 변수명;
		// 정수를 담을수 있는 number1이라는 이름을 가지는 메모리 공간을 생성
		int number1;
		
		
		// 초기화(초기값을 넣는) 방법
		// 변수 = 데이터;
		// number1라는 메모리 공간에 9라는 데이터를 초기값으로 넣음
		number1 = 9;
		...
		// 정수를 담을 수 있는 number2 라는 
		// 이름을 가지는 메모리 공간을 생성하고 그 공간에 초기값 37을 넣음
		int number2 = 37;
		...
		// 처음 변수에 값을 할당하는 행위가 아니기 때문에 해당코드는 초기화가 아님
		number1 = 12;
		System.out.println(number1);
...
//		int int;
		...
		// 비문법상 규칙(암묵적 룰)
		// 띄워쓰기 규칙
		// ex) web site address 를 변수명으로 선언하고 싶을때
		...
		// lowerCamelCase : 변수, 함수, 메서드 (첫문자를 소문자로 시작) 보통 컴파일언어에서 사용
		
		// UPPER_SNAKE_CASE : 상수형 변수 (모든 문자를 대문자로 작성)
		// lower_snake_case : 변수, 함수, 메서드 (모든 문자를 소문자로 작성) 보통 인터프리트언어나 스크립트언어에서 사용
