...
class Korean {
	String name;
	int age;
	static String nationality = "대한민국";	// 초기값을 넣을수 있음
...
class TriangleMath {
	...
	// PI, getCircleArea(double)는 SRP 원칙에 위배됨
	...
	static double getCircumference(double bottom, Double height, double hypotenuse) {
		...
		if (bottom < 1 || height < 1 || hypotenuse < 1) {
			return 0;
		}
...
public class ClassAndObject {
	...
	public static void main(String[] args) {
		...
		korean1.name = "홍길동";
		korean1.age = 20;
//		korean1.nationality = "대한민국";	// nationality의 초기값과 같기 때문에 생략
