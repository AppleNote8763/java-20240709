...
class AccessModifierRun {
	...
	void method() {
		...
		// 접근제어자가 각각 public, protected, default이기 때문에 같은 패키지 내부에서 접근이 가능
		instance.protectedVariable = 0;
		instance.protectedVariable = 0;
		instance.defaultVariable = 0;
		
		// AccessModifier의 privateVariable 필드는
		// 접근제어자가 각각 private이기 때문에 같은 패키지 내부에서 접근이 불가능
...
public class AccessModifier {
	...
	public static void main(String[] args) {
		...
		// AccessModifier의 publicVariable, protectedVariable, defaultVariable, privateVariable 필드는
		// 접근제어자가 각각 public, protected, default, private이기 때문에 같은 클래스 내부에서 접근이 가능
		instance.protectedVariable = 0;
		instance.protectedVariable = 0;
		instance.defaultVariable = 0;
		instance.privateVariable = 0;
