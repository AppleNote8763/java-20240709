...
interface AreaCalculation {
	...
	double PI = 3.14;	// public static final 이 double 앞에 생략되어있음
	
	double getTriangleArea(double bottom, double height);		// public abstract 이 double 앞에 생략되어있음
...
// 인터페이스는 다중 구현이 가능함
class MyCalculation implements Calculation {		// Calculation = AreaCalculation, CircumferenceCalculation
